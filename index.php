...
|--------------------------------------------------------------------------
| Copyright © 2026 SachinRathnayaka
|
| This file is part of an educational project developed by SachinRathnayaka.
...
@media (min-width: 768px){
  .rj-rail{ grid-auto-columns: minmax(300px, 1fr); }
    ...
    <!-- HERO / HOME -->
<!-- HERO / HOME -->
<section class="home-section hero-v2 overlay" id="home-section" style="position: relative; overflow: hidden; min-height: 75vh;">

  <!-- Video background -->
  <video autoplay muted loop playsinline
         style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: -1;">
    <source src="Videos/back.mp4" type="video/mp4">
    <!-- Fallback image eka (video support neththan) -->
    <img src="images/tst.jpg" alt="fallback" style="display:none;">
  </video>

  <!-- Text & buttons tiyena layer eka -->
  <div class="container" style="position: relative; z-index: 1;">
    <div class="row align-items-center justify-content-center min-vh-75">
      <div class="col-lg-10">
        <!-- mehema oyage title, description, button dana oni -->
        <!--<h1 class="text-white">Online Job Protal</h1>
        <p class="text-light">Sachin Rathnayaka</p>
